...
const TranslatedDisplay = ({ translatedText }) => {
    ...
    return (
        <div className="flex flex-col w-full h-full bg-gray-300 p-2 rounded-md shadow-md">
            <div className="flex flex-row justify-between">
                <p className="text-lg font-bold">คำเเปล</p>
                <div>
                    <button className="active:outline-none focus:outline-none" onClick={playSoundHandler}>
                    ...
                    <button className="ml-2 active:outline-none focus:outline-none" onClick={reloadAppHandler}>
                        <div className="transform transition duration-300 ease-in-out hover:scale-125">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
